...
//       scene.background = new THREE.Color(0x0f3b2c); // Czarne tło
...
//         1000
//       );
//       camera.position.z = 400; // Kamera na środku patrząca w dół
//       camera.rotation.x = 0; // Ustawienie kamery pionowo
...
//         positions[i + 1] -= 0.5; // Ruch w dół (zmiana współrzędnej Y)
//         if (positions[i + 1] < -400) {
//           positions[i + 1] = 400; // Reset pozycji gwiazdy, gdy opuści ekran
//         }
//       }
